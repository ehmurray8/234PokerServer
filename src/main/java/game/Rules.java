...
public class Rules {
   ...
   */
  public Rules(double smallBlind, double bigBlind, double ante, int timeLimitSecs, int maxCapacity,
               double[] prizes,
               int blindLevelTimeMinutes, double[] bigBlinds, double[] smallBlinds, double[] antes,
               GameType gameType) {
  ...
  public String toString() {
    return "Big Blind: " + this.bigBlind + ", Small Blind: " + this.smallBlind + ", Ante: "
        + this.ante + ", Time limit: " + this.timeLimitSecs + "s";
  }
}
