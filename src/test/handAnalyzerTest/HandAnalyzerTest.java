...
/**
 * This class tests the HandAnalyzerComparator class to determine if it can
 * correctly compare hands.
 *
 * @author Emmet Murray
 */
public class HandAnalyzerTest {
    ...
    /**
     * The HandAnalyzerComparator used throughout the class to compare the
     * class.
     */
