...
public class GameTest {
  ...
  @Test
  public void testAddToEmptyTable() throws Exception {
  ...
  public void testTwoGameRuns() {
    ...
    var flopList = Arrays.asList(new OptionSelection(SelectionType.BET),
        new OptionSelection(SelectionType.CALL));
    ...
    var riverList = Arrays.asList(new OptionSelection(SelectionType.CHECK),
        new OptionSelection(SelectionType.CHECK));

    var nextHandList = Arrays.asList(new OptionSelection(SelectionType.RAISE),
        new OptionSelection(SelectionType.FOLD));
